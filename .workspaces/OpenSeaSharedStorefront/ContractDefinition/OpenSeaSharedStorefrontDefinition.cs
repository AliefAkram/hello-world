...
namespace .workspaces.Contracts.OpenSeaSharedStorefront.ContractDefinition
{


    public partial class OpenSeaSharedStorefrontDeployment : OpenSeaSharedStorefrontDeploymentBase
    {
        public OpenSeaSharedStorefrontDeployment() : base(BYTECODE) { }
        public OpenSeaSharedStorefrontDeployment(string byteCode) : base(byteCode) { }
    }

    public class OpenSeaSharedStorefrontDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public OpenSeaSharedStorefrontDeploymentBase() : base(BYTECODE) { }
        public OpenSeaSharedStorefrontDeploymentBase(string byteCode) : base(byteCode) { }
