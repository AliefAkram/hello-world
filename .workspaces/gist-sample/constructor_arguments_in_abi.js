...
var parameterTypes = ['bytes', 'bool', 'uint256[]'];
var parameterValues = ['0x495f947276749Ce646f68AC8c248420045cb7b5e', true, [ 1, 2, 3 ] ];

var encoded = abi. rawEncode (parameterTypes, parameterValues);
console. log("Encoded: \n",encoded. toString('hex'));

//returns the decodwd array of arguments
//var decoded = abi. rawDencode (parameterTypes, endoded);
//console. log("decoded: \n",decoded);
